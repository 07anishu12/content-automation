...
if not slack_token:
    print("Warning: SLACK_BOT_TOKEN not configured. Slack functions will be bypassed.")
...
def send_slack_message(text):
    if not slack_token:
        print("Warning: Slack message send bypassed (no SLACK_BOT_TOKEN).")
        return
...
def upload_slack_file(file_path, file_name, initial_comment):
    if not slack_token:
        print("Warning: Slack file upload bypassed (no SLACK_BOT_TOKEN).")
        return
